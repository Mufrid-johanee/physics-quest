...
This file is **design exploration** for an Energy Refinery layout. **Canonical Zone 02** in the rebuild is the Assessment Wing / Map C path with badge **Radiant Crest**. Floor4 mini-game is still a PLAY→SUCCESSFUL **placeholder**. Living status: `Docs/PROGRESS.md`, `Docs/MINIGAME_IMPLEMENTATION.md`, `Docs/MASTER_GAME_SPEC.md`.
